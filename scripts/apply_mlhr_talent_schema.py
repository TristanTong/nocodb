# -*- coding: utf-8 -*-
"""Create mlhr schema tables on mldata (192.168.100.89)."""
...
def main() -> int:
    ...
    sql_path = pathlib.Path(__file__).resolve().parent / "mlhr_talent_phase1.sql"
    ...
    cur.execute(
        ...
        WHERE table_schema = 'mlhr'
        ORDER BY table_name
        """
    )
    tables = [r[0] for r in cur.fetchall()]
    print("mlhr tables:", tables)
    cur.close()
    conn.close()
    print("OK mldata.mlhr ready")
    return 0
