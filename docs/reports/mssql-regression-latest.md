...
| 用例 | 结果 | 详情 |
|------|------|------|
| TC-ENV-01 health | PASS | {'message': 'OK', 'timestamp': 1788421347496, 'uptime': 54.327776712} |
...
| TC-MSSQL-META-DIFF load metadata diff | PASS | 200 listen=completed n=50 {"id":"jobjebmgx4dtnx0rw"} |
| TC-MSSQL-META-SYNC trigger | PASS | 200 listen=completed {"id":"job73igmbi8gbzwl8"} |
...
| TC-MSSQL-20 insert+update+delete smoke | PASS | table=_nc_p2_1784943212 ins=200 id=2 upd=200 del=200 |
